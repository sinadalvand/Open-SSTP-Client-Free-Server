...
## Installation
You can download and install the latest version via **[direct link](https://github.com/mfoolady/Open-SSTP-Client-Free-Server/releases/download/v7.2.2/osc-free-7.2.2.apk)**.
